        ...
        `}>
          ...
          <div className="flex flex-col h-full">
            <div className="flex-1 space-y-2 md:space-y-3">
              ...
              {/* SVG illustration for Restraining Order card */}
              {index === 0 && (
                <div className="mt-4 flex justify-center">
                  <svg width="173" height="131" viewBox="0 0 173 131" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="title desc" className="w-full max-w-[160px] h-auto opacity-80">
                    <title id="title">Restraining Order — Shield+Heart, Hand+Shield, Lock+Home</title>
                    <desc id="desc">Three small, hand-drawn motifs with wobbly lines and soft blobs: a shield with a heart, a stop hand with a small shield, and a lock with a simple home outline.</desc>

                    {/* soft color blobs (no outlines) */}
                    <path d="M12 26c10-8 32-8 44 1 11 9 3 22-13 27-16 5-36 0-39-12-2-7 1-12 8-16Z" fill="#F5E6DA"/>
                    <path d="M65 25c11-7 34-5 42 4 8 9 1 20-10 24-12 4-29 2-36-6-7-8-5-16 4-22Z" fill="#EAE8F4"/>
                    <path d="M120 27c10-6 29-5 37 4 8 9 2 19-8 23-10 4-25 3-32-4-7-7-6-16 3-23Z" fill="#F9DCC4"/>

                    {/* LEFT: Shield + Heart (protection with care) */}
                    {/* shield (wobbly) */}
                    <path d="M18 28
                           Q28 21 38 24
                           Q48 21 58 28
                    ...
                    {/* MIDDLE: Open hand + small shield */}
                    {/* hand (stop gesture, wobbly) */}
                    <path d="M72 70
                           Q70 58 74 48
                           Q76 42 80 44
                           Q81 36 86 38
                           ...
                           Q84 72 80 72
                           Q76 72 74 68"
                          stroke="#111" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                    {/* small shield to the right */}
                    <path d="M108 48
                           Q114 45 120 48
                           L120 60
                           Q114 66 108 62 Z"
                          stroke="#111" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" fill="none"/>

                    {/* RIGHT: Lock + simple home outline */}
                    {/* home outline (wobbly) */}
                    <path d="M129 74
                           L139 63
                           L150 74
                    ...
                    <path d="M139 63
                           Q140 62 141 63
                           M135 74 L144 74"
                          stroke="#111" strokeWidth="2.0" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.7"/>

                    {/* lock in front of house */}
                    {/* shackle */}
                    <path d="M152 68
                           q 0 -10 10 -10
                           q 10 0 10 10
                          ...
                          stroke="#111" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                    {/* body */}
                    <rect x="154" y="78" width="20" height="16" rx="3" stroke="#111" strokeWidth="2.6" fill="none"/>
                    {/* keyhole (simple squiggle) */}
                    <path d="M164 84
                           q -2 2 2 4
                           q -2 2 -2 4"
                          stroke="#111" strokeWidth="2.0" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                  </svg>
                </div>
              )}
